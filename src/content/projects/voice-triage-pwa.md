...
hero: ../../assets/projects/voice-triage-pwa/hero.svg
heroAlt: "Left: phone mockup showing the My Health tab with a 92% adherence continuity score, medication schedule, and weekly dose grid. Right: serverless architecture diagram of the backend, VOICE INPUT to API GATEWAY to LAMBDA, with LAMBDA branching to BEDROCK and DYNAMODB, over a datasheet-style spec block."
---
...
![Phone mockup of the My Health tab showing a 92% adherence continuity score, current medication schedule, and weekly dose grid with taken, late, and missed states.](../../assets/projects/voice-triage-pwa/ui.svg)
...
Lambda cold starts without metrics cost more time than it should have.